...
Route::get('/', 'AdminPostsController@welcomeView');
Route::get('post/search', 'AdminPostsController@searchResult');
...
Route::group(['middleware'=>'admin'], function(){
	...
	//post routes
	// Route::get('/category/{id}', 'AdminPostsController@getAllCat');
...
Route::get('/category/{id}', ['as'=>'home.category', 'uses'=>'AdminPostsController@getAllCat']);
